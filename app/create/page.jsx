...
function Create() {
  ...
  return (
    <div className='flex flex-col items-center p-5 md:px-24 lg:px-36 mt-20'>
        <h2 className='font-bold text-4xl text-primary'>Start Generating your personal material</h2>
        <p className='text-gray-500 text-lg'>Fill all the details required to genrate your personalised Study Material</p>
